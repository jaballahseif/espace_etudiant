...
<% } %>
    <form method="get" action="Servlet">
               ...
               <option value="etudiant" selected>Student</option>
               </select>
    ...
    <br>
                ...
                <div class="d-grid">
                  <button class="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-2" name="action" value="addetudiant" type="submit">AJOUTER</button>
                </div>
