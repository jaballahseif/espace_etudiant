...
<% } %>
    ...
    <div class="blog-card">
        ...
        <div class="description">
            ...
            <p>here you can view your notes </p>
            <p class="read-more">
                <a class="btn btn-primary" href="note.jsp">View Notes</a>
            </p>
        </div>
    </div>
    <div class="blog-card alt">
        <div class="meta">
           ...
           <div class="description">
            ...
            <p>here you can view documents uploadede by teachers</p>
            <p class="read-more">
                <a class="btn btn-primary">view documents</a></p>
        </div>
    </div>
</div>
</body>
